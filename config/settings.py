...
elif os.getenv('POSTGRES_ENABLED', '0') == '1':
    DATABASES = {'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': os.getenv('POSTGRES_DB', 'aimai'),
        'USER': os.getenv('POSTGRES_USER', 'aimai'),
        'PASSWORD': os.getenv('POSTGRES_PASSWORD', 'aimai'),
...
ACCOUNT_FORMS = {'signup': 'config.forms.SignupForm'}
